      ...
      <div className="container">
        <div className="text-center container mx-auto">
          ...
          <p className="mt-4 text-lg">
            Our Pet Clinic provides top-notch veterinary care, while our Pet
            Care and Pet Café services ensure your pet’s health and happiness.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 justify-around p-12">
          <div className="flex-1 space-y-6 md:space-y-8 p-6 rounded-lg shadow-lg bg-purple-100">
            <div className="flex flex-col space-y-8 justify-around">
              ...
              <p>
                ...
                services. From routine check-ups to advanced treatments, we’ve
                got you covered.
              </p>
              <Link href="/pet-clinics">
                <Button className="rounded-3xl bg-[#00b2d8] hover:bg-[#2cc4e6] text-white">
                  Learn more ➔
                </Button>
              </Link>
            </div>
          ...
          <div className="flex-1 space-y-6 md:space-y-8 p-6 rounded-lg shadow-lg bg-red-100">
            <div className="flex flex-col space-y-8 justify-around">
              ...
              <p>
                Keep your pet happy and healthy with our dedicated care
                services. We offer grooming, daycare, and personalized attention
